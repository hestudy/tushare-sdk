 ...
 * rspress 配置文件契约
 * 
 * 定义文档站的核心配置结构,包括站点信息、主题配置、插件等
 */

import type { RspressConfig } from '@rspress/core';

/**
 * rspress 配置契约
 */
export const rspressConfig: RspressConfig = {
  /**
   * 站点根路径
   * 如果部署在子路径下,需要设置此项
   */
  ...
  themeConfig: {
     ...
     */
    editLink: {
      docRepoBaseUrl: 'https://github.com/your-org/tushare-sdk/tree/main/apps/docs/docs',
      text: '在 GitHub 上编辑此页',
    },
  ...
  //     label: '简体中文',
  //     title: 'Tushare SDK',
  //     description: 'Tushare SDK 官方文档',
  //   },
  //   {
  //     lang: 'en-US',
  //     label: 'English',
  //     title: 'Tushare SDK',
  //     description: 'Official documentation for Tushare SDK',
  //   },
  // ],
