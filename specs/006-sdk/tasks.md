...
- [ ] T086 运行所有 E2E 测试,确保通过率 100% - 已配置自动启动服务器,端口 5173
...
- **User Story 1 (Phase 3)**: 14 tasks (6 tests + 8 implementation)
- **User Story 2 (Phase 4)**: 12 tasks (4 tests + 8 implementation)
- **User Story 3 (Phase 5)**: 9 tasks (3 tests + 6 implementation)
- **User Story 4 (Phase 6)**: 8 tasks (4 tests + 4 implementation)
- **Responsive (Phase 7)**: 8 tasks
- **Advanced Components (Phase 8)**: 10 tasks
- **Polish (Phase 9)**: 13 tasks

**Parallel Opportunities**: 约 60% 的任务可并行执行(标记 [P])

**MVP Scope**: Phase 1 + Phase 2 + Phase 3 = 31 tasks (User Story 1 only)

**Estimated Effort**:
- MVP (US1): 2-3 天 (单人) 或 1 天 (2-3 人并行)
- Full Feature (US1-US4): 5-7 天 (单人) 或 2-3 天 (团队并行)
